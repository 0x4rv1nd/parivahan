...
<div>
  ...
  >
    <span className="flex items-center px-3 text-sm text-gray-500 bg-gray-50 border-r border-gray-300 rounded-l-lg select-none">
      +91
    </span>
    <input
      id="phone"
      ...
      className="flex-1 min-w-0 px-3 py-2 text-sm text-gray-900 placeholder-gray-400 rounded-r-lg outline-none bg-transparent"
  ...
  {errors.phone && (
    <p id="phone-error" className="text-red-600 text-sm mt-1.5" role="alert">
      {errors.phone}
    </p>
  )}
</div>
